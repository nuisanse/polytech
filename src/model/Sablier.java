...
public class Sablier extends JApplet implements ActionListener, MouseListener {
	/**
	...
	public Sablier(PrincipalCadre frame)
	{
		super();
		this.cadre=frame;
		init();
	...
	public void init() {
		...
		else remaining = 60000; // 1 minute by default
